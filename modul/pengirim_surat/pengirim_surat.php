<?php
      ...
      if(isset($_POST['bsimpan']))
      {
            ...
            if(@$_GET['hal'] == "edit"){
              //perintah edit
                 //ubah data
            $ubah = mysqli_query($koneksi, "UPDATE tebl_pengirim_surat SET 
            ...
            {
              //perintah data yang sudah di edit
              //simpa data
            $simpan = mysqli_query($koneksi, "INSERT INTO tebl_pengirim_surat 
                                              VALUES ('', 
                                                      '$_POST[nama_pengirim]', 
                                                      '$_POST[alamat]',
                                                      '$_POST[no_hp]',
      ...
      if(isset($_GET['hal']))
      {
        ...
        $tampil = mysqli_query($koneksi, "SELECT *FROM tebl_pengirim_surat where id_pengirim_surat='$_GET[id]'");
        ...
        if($data)
        {
          ...
          $hapus = mysqli_query($koneksi, "DELETE FROM tebl_pengirim_surat WHERE id_pengirim_surat='$_GET[id]' ");
          if($hapus){
            echo "<script>
...
<div class="card mt-3">
  ...
  <table class="table table-borderd table-hovered table-striped"> 
      ...
      <?php
          $tampil = mysqli_query($koneksi, "SELECT * from tebl_pengirim_surat order by id_pengirim_surat desc");
          $no = 1;
